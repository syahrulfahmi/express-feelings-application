...
import kotlinx.android.synthetic.main.dialog_pop_up_no.*
...
class PopUpDialogFragmentNo : DialogFragment() {

    private var widthSize = 0
    private var name = ""

    companion object {
        fun newInstance(widthSize: Int, name: String) = PopUpDialogFragmentNo().apply {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.dialog_pop_up_no, container, false)
